...
void LoadingResScene::loadResources()
{
    ...
    SpriteFrameCache::getInstance()->addSpriteFramesWithFile("Play3.plist");
    numberOfLoadedRes++;
    ...
    Director::getInstance()->getTextureCache()->addImageAsync("upload.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
}
